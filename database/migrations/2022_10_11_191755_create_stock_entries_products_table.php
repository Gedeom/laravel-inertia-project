...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('stock_entries_products', function (Blueprint $table) {
            $table->id();
            $table->foreignId('stock_entry_id')->references('id')->on('stock_entries')->constrained()->restrictOnDelete();
    ...
    {
        Schema::dropIfExists('stock_entries_products');
    }
};
